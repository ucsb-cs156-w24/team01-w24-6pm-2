...
public class UniversityControllerTests {
    ...
    @MockBean
    private UniversityQueryService mockUniversityQueryService;
    ...
    public void test_getUniversity() throws Exception {
        ...
        String url = String.format("/api/universities/get?name=%s", name);
        ...
        // Optionally verify that the service was called with the correct parameters
        verify(mockUniversityQueryService).getJSON(eq(name));
    }
}